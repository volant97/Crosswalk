...
function ChatRoom() {
  ...
  return (
    <>
      <div ref={chatContainerRef} className="relative  w-full h-[33.5rem] overflow-y-auto scrollbar-hide">
        ...
        {senderMessage?.map((message: string, index: number) => {
          return (
            <Fragment key={index}>
              <div className="relative left-[150px] w-[full] flex flex-row gap-[0.38rem] mt-[1rem]">
                <h1 className="absolute text-[0.75rem] text-gray-999 bottom-[1px] left-[-40px] whitespace-nowrap">
                  {getCurrentTime()}
                </h1>
                <div className=" text-[0.875rem] px-[1.25rem] py-[0.5rem] bg-lightGreen rounded-tl-[1.8rem] rounded-tr-[1.8rem] rounded-bl-[1.8rem] w-[10rem]">
        ...
        {receiverMessage.map((message: string, index: number) => {
          return (
            <Fragment key={index}>
              <div className="relative flex flex-row gap-[0.38rem] mt-[1rem]">
                <Image
                  ...
                  alt="아바타 이미지"
                />
                <div className=" text-[0.875rem] px-[1.25rem] py-[0.5rem] bg-lightGreen rounded-tl-[1.8rem] rounded-tr-[1.8rem] rounded-br-[1.8rem] w-[10rem]">
                  <h1 className="font-medium">{message}</h1>
                </div>
                <h1 className="absolute text-[0.75rem] text-gray-999 mt-[20px] whitespace-nowrap right-[80px] bottom-[1px]">
                  {getCurrentTime()}
                </h1>
              </div>
            </Fragment>
