  ...
  return (
    <>
      ...
      <form
        ...
        className="absolute left-1/2 transform -translate-x-1/2 flex flex-row flex-warp gap-[0.75rem] items-center w-[20rem] h-[3.25rem] bottom-0 border-1 border-gray-DDD border-solid rounded-full "
      >
        <input
          value={inputValue}
